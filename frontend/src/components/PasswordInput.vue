...
<template>
  <div class="password-input">
    <input :type="showPassword ? 'text' : 'password'" :value="modelValue"
      @input="emit('update:modelValue', $event.target.value)" placeholder="Contrasenya" :class="{ 'error': hasError }">
    ...
    <button type="button" class="toggle-password" @click="togglePassword"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#616161" stroke-width="2"
