<template>
    <div class="student-profile-wrapper">
      <div class="student-profile">
        ...
        <ProfileSubjects :educationList="education" />
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        studentBio: 'A passionate learner who loves to build web applications.',
        education: [
