...
<template>
    <div class="flex flex-col justify-center items-center bg-white">      
        <h1 class="text-2xl">Listado Alumnos</h1>
                    ...
                    <div class="flex flex-col items-center">
                        <div class="card-container">
                            ...
                            <div class="text-center">
                                ...
                                <button @click="viewStudentDetails(student)" class="mt-4 bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 focus:outline-none
